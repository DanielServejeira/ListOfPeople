 ...
 */
package seproject.main;
import seproject.entities.Person;
import java.util.Scanner;
import java.util.ArrayList;
import seproject.persistence.Persistence;
...
public class SEProject {
    ...
    static final String FILE_NAME = "listOfPeople.dat";
    /**
     * @param args the command line arguments
     */
    public static void main(String[] args){
        try (Scanner scanner = new Scanner(System.in)) {
            ArrayList <Person> people = Persistence.loadArchive(FILE_NAME, new ArrayList<>());
    ...
    private static void savePeople(ArrayList<Person> people) {
        Persistence.saveArchive(people, FILE_NAME);
    }
}
